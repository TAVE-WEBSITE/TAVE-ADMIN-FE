...
export default function History() {
    ...
    const historyData = [
        ...
        {
            number: '1-2',
            description: ['TAVE 창립', 'TAVE 1기 회원 모집', 'EXEM, (주)유비콤테크놀로지 후원사 선정'],
        },
    ];
    ...
    const searchedData = searchInput
        ? historyData.filter((item) =>
              item.description.some((desc) => desc.toLowerCase().includes(searchInput.toLowerCase()))
          )
        : historyData;
        ...
        <div className="flex flex-col pt-40 min-h-screen bg-gradient-to-b from-[#121212] via-[#121212] via-40% to-[#5586FF]">
            ...
            <div className="m-auto w-4/5 max-w-screen-xl flex-grow pb-40">
                ...
                <div className="flex justify-between mt-16">
                    ...
                    <button className="text-white w-25 bg-btn-blue items-center rounded-md py-2 px-5 p-2">
                        이력 추가
                    </button>
                </div>
                <div className="mt-12 flex flex-col gap-8">
                    {searchedData.length === 0 ? (
                        <div className="text-center text-gray-500 text-2xl">검색 결과가 없습니다</div>
                    ) : (
