...
export default function DropDown({ valueList, setValue, isOpen, setIsOpen }) {
  ...
  return (
    <div className="relative inline-block w-full font-extralight">
      <div
        onClick={() => setIsOpen(!isOpen)}
        className={`flex items-center bg-white p-2 border border-gray-300 cursor-pointer gap-2.5 w-full ${
          isOpen
      ...
      {isOpen && (
        <ul className="absolute bg-white border border-gray-300 rounded-b-md shadow-[5px_5px_9px_0px_rgba(0,0,0,0.35)] w-full">
